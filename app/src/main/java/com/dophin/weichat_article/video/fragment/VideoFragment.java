package com.dophin.weichat_article.video.fragment;
    ...
    private void initView() {
        ...
        videoSwipe.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                statue = 1;
                listSize = list.size();
                HttpMethods.getInstance().getNewsClassify(new ProgressSubscriber<News>(subscriberOnNextListener,mActivity,1),String.valueOf(page),String.valueOf(9));
...
//        });
        ...
        HttpMethods.getInstance().getNewsClassify(new ProgressSubscriber<News>(subscriberOnNextListener,mActivity,1),String.valueOf("1"),String.valueOf(9));
