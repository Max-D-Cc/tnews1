...
public class CommentActivityAdapter extends RecyclerView.Adapter<CommentActivityAdapter.ViewHolder> {
    ...
    public CommentActivityAdapter(Context context, List<Comment> list) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.itemCommentTime.setText(comment.getJLTIME() + " 回复>");
